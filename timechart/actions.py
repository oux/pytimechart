...
""",
         "default":True},
        {},
        {"name": "toggle_ipc","tooltip":"""Show/Hide the ipc_events.

Wake events are generated by the "sched_ipcup" trace_event. ipc events are
represented by a row connecting a process to another.

Reason of ipcs can be for example:
